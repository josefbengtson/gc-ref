...
class GenMetricMasked():
    def __init__(self, kid_subset=1000, device='cpu'):
    ...
    def update(self, gt_view, pred_view):
        ...
        # import ipdb; ipdb.set_trace()
        self.masked_fid.update(gt_view, real=True)
        self.masked_fid.update(pred_view, real=False)

        # self.masked_kid.update(gt_view, real=True)
        # self.masked_kid.update(pred_view, real=False)

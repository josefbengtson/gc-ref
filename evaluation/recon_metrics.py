...
class ReconMetricMasked():
    ...
    def update(self,gt_view, pred_view):
        """ Compute reconstruction metrics.
        ...
        # Mask: 0 -> no information
        # NOTE: this is a bit higher since the region mask=0 is all correct
        self.mask_lpips.update(gt_view, pred_view)
        self.mask_psnr.update(gt_view, pred_view)
        self.mask_ssim.update(gt_view , pred_view)
        self.cnt += gt_view.shape[0]
        return
